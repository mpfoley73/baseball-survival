...
bio_2 <- bio_1 %>%
  mutate(
    ...
    throws = factor(throws, levels = c("L", "R", "B"), 
                    labels = c("Left", "Right", "Both")),
    hof = factor(hof, levels = c("NOT", "HOF"), labels = "HoF", "Not")
  )
```
...
title_text <- "MLB Players Are Getting Taller."
...
p1 + ggtitle(paste("Fig 1.", title_text))
```
...
title_text <- "MLB Players Are Getting Heavier."
...
p2 + ggtitle(paste("Fig 2.", title_text))
```
...
title_text <- "MLB Players Are Getting More Massive."
...
p3 + ggtitle(paste("Fig 3.", title_text)) 
```
...
```{r}
title_text <- "Left-handedness increased until 1950."
p4a <- bio %>% plot_p4()
p4a +
  scale_color_manual(values = c("Left" = "#F4793E", 
                                "Right" = "#231F20", 
                                "Both" = "#C49D6E", 
                                "N/A" = "#E8D8C4")) +
  ggtitle(paste("Fig 4a.", title_text, "(raw)"))
```
...
p4b +
  scale_color_manual(values = c("Left" = "#F4793E", 
                                "Right" = "#231F20", 
                                "Both" = "#C49D6E")) +
  ggtitle(paste("Fig 4a.", title_text, "(cleaned)"))
```
...
p5 + ggtitle(paste("Fig 5.", title_text))
```
...
```{r warning=FALSE, message=FALSE}
title_text <- "Top Domestic Sources of Talent."
p6 <- state_dat %>%
...
p6 + ggtitle(paste("Fig 6.", title_text))
```
