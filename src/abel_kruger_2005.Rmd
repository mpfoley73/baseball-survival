...
matches <- age_matched_cohort[random_rownums, ] %>%
  ...
  select(playerID.cohort, nameFirst, nameLast, hofID, birthYear, deathYear,
...
Let's look at some of the matches. Dick Allen was nominator to the Hall but he was never inducted. He was still alive when Tony Perez was inducted in 2000. Both were born in 1942. Art Bues was alive when Tris Speaker was inducted in 1937, and both were born in 1888. Glen Cox shared the same birth year as five Hall of Famers inducted while still alive. Glen Cox was still alive as of 2002.

```{r}
matches %>% arrange(playerID.cohort)
```
